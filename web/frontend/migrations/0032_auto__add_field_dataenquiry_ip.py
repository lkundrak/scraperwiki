...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataEnquiry.ip'
        db.add_column('frontend_dataenquiry', 'ip', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataEnquiry.ip'
        db.delete_column('frontend_dataenquiry', 'ip')
