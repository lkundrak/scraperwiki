...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.messages'
        db.add_column('frontend_userprofile', 'messages', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.messages'
        db.delete_column('frontend_userprofile', 'messages')
