...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlertTypes.label'
        db.add_column('frontend_alerttypes', 'label', orm['frontend.alerttypes:label'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'AlertTypes.label'
        db.delete_column('frontend_alerttypes', 'label')
