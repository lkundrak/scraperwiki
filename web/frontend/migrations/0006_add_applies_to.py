...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlertTypes.applies_to'
        db.add_column('frontend_alerttypes', 'applies_to', orm['frontend.alerttypes:applies_to'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'AlertTypes.applies_to'
        db.delete_column('frontend_alerttypes', 'applies_to')
