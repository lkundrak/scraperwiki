...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.alerts_last_sent'
        db.delete_column('frontend_userprofile', 'alerts_last_sent')

        # Deleting field 'UserProfile.alert_frequency'
        db.delete_column('frontend_userprofile', 'alert_frequency')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'UserProfile.alerts_last_sent'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.alerts_last_sent' and its values cannot be restored.")

        # Adding field 'UserProfile.alert_frequency'
        db.add_column('frontend_userprofile', 'alert_frequency', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
