...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('frontend_usertouserrole', (
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='from_user', to=orm['auth.User'])),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to_user', to=orm['auth.User'])),
        ))
