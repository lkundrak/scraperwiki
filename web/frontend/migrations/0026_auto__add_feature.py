...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('frontend_feature', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('public', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('frontend', ['Feature'])

        # Adding M2M table for field features on 'UserProfile'
        db.create_table('frontend_userprofile_features', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['frontend.userprofile'], null=False)),
            ('feature', models.ForeignKey(orm['frontend.feature'], null=False))
        ))
        db.create_unique('frontend_userprofile_features', ['userprofile_id', 'feature_id'])


    def backwards(self, orm):
        
        # Deleting model 'Feature'
        db.delete_table('frontend_feature')

        # Removing M2M table for field features on 'UserProfile'
        db.delete_table('frontend_userprofile_features')
    ...
    models = {
        ...
        'frontend.userprofile': {
            ...
            'email_on_comments': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'features': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'features'", 'symmetrical': 'False', 'to': "orm['frontend.Feature']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
