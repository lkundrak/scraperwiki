...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Alerts.event_id'
        # (to signature: django.db.models.fields.PositiveIntegerField(null=True, blank=True))
        db.alter_column('frontend_alerts', 'event_id', orm['frontend.alerts:event_id'])
        
        # Changing field 'Alerts.object_id'
        # (to signature: django.db.models.fields.PositiveIntegerField(null=True, blank=True))
        db.alter_column('frontend_alerts', 'object_id', orm['frontend.alerts:object_id'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Alerts.event_id'
        # (to signature: django.db.models.fields.PositiveSmallIntegerField(null=True, blank=True))
        db.alter_column('frontend_alerts', 'event_id', orm['frontend.alerts:event_id'])
