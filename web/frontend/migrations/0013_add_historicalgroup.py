...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Alerts.historicalgroup'
        db.add_column('frontend_alerts', 'historicalgroup', orm['frontend.alerts:historicalgroup'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Alerts.historicalgroup'
        db.delete_column('frontend_alerts', 'historicalgroup')
    ...
    models = {
        ...
        'frontend.alerttypes': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'blank': 'True'})
        },
