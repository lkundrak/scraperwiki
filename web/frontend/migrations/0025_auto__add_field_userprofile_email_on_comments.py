...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.email_on_comments'
        db.add_column('frontend_userprofile', 'email_on_comments', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.email_on_comments'
        db.delete_column('frontend_userprofile', 'email_on_comments')
