...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.apikey'
        db.add_column('frontend_userprofile', 'apikey', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.apikey'
        db.delete_column('frontend_userprofile', 'apikey')
