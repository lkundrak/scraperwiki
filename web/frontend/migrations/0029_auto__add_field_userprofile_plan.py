...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.plan'
        db.add_column('frontend_userprofile', 'plan', self.gf('django.db.models.fields.CharField')(default='free', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.plan'
        db.delete_column('frontend_userprofile', 'plan')
