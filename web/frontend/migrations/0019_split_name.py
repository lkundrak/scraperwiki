...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataEnquiry.first_name'
        db.add_column('frontend_dataenquiry', 'first_name', orm['frontend.dataenquiry:first_name'])
        
        # Adding field 'DataEnquiry.last_name'
        db.add_column('frontend_dataenquiry', 'last_name', orm['frontend.dataenquiry:last_name'])
    ...
    def backwards(self, orm):
        ...
        db.add_column('frontend_dataenquiry', 'name', orm['frontend.dataenquiry:name'])
