...
urlpatterns = patterns('',
   ...
   url(r'^(?P<language>(python|ruby|php|shared|javascript))/tutorials/$',views.tutorials, name="tutorials"),      
   url(r'^(?P<language>(python|ruby|php|shared|javascript))/(?P<path>[\w_\-\.]+)/$',views.docmain, name="docs"),   
