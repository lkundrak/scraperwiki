...
urlpatterns = patterns('',
   ...
   url(r'^(?P<language>(python|ruby|php|perl|shared|javascript))/tutorials/$',views.tutorials, name="tutorials"),
   url(r'^(?P<language>(python|ruby|php|perl|shared|javascript))/(?P<path>[\w_\-\.]+)/$',views.docmain, name="docs"),
