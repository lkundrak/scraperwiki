...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DomainScrape.pages_scraped'
        # (to signature: django.db.models.fields.IntegerField(default=0))
        db.alter_column('codewiki_domainscrape', 'pages_scraped', orm['codewiki.domainscrape:pages_scraped'])
        
        # Changing field 'DomainScrape.bytes_scraped'
        # (to signature: django.db.models.fields.IntegerField(default=0))
        db.alter_column('codewiki_domainscrape', 'bytes_scraped', orm['codewiki.domainscrape:bytes_scraped'])
