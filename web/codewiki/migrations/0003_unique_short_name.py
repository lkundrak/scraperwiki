...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Creating unique_together for [short_name] on Code.
        db.create_unique('codewiki_code', ['short_name'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [short_name] on Code.
        db.delete_unique('codewiki_code', ['short_name'])
