...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CodeSetting'
        db.create_table('codewiki_codesetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.related.ForeignKey')(related_name='settings', to=orm['codewiki.Code'])),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('value', self.gf('django.db.models.fields.TextField')()),
            ('last_edited', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('last_edit_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('codewiki', ['CodeSetting'])


    def backwards(self, orm):
        
        # Deleting model 'CodeSetting'
        db.delete_table('codewiki_codesetting')
    ...
    models = {
        ...
        'codewiki.code': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'through': "'UserCodeRole'"}),
