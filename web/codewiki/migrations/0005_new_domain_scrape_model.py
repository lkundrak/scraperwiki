...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DomainScrape'
        db.create_table('codewiki_domainscrape', (
            ('id', orm['codewiki.DomainScrape:id']),
            ('scraper_run_event', orm['codewiki.DomainScrape:scraper_run_event']),
            ('domain', orm['codewiki.DomainScrape:domain']),
            ('bytes_scraped', orm['codewiki.DomainScrape:bytes_scraped']),
            ('pages_scraped', orm['codewiki.DomainScrape:pages_scraped']),
        ))
        db.send_create_signal('codewiki', ['DomainScrape'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'DomainScrape'
        db.delete_table('codewiki_domainscrape')
    ...
    models = {
        ...
        'codewiki.domainscrape': {
            'bytes_scraped': ('django.db.models.fields.IntegerField', [], {}),
            'domain': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pages_scraped': ('django.db.models.fields.IntegerField', [], {}),
