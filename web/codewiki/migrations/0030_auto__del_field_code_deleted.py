...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Code.deleted'
        db.delete_column('codewiki_code', 'deleted')


    def backwards(self, orm):
        
        # Adding field 'Code.deleted'
        db.add_column('codewiki_code', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
