...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('codewiki_usercodeediting', (
            ('code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codewiki.Code'], null=True)),
            ('runningsince', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('twisterscraperpriority', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('closedsince', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('editingsince', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('twisterclientnumber', self.gf('django.db.models.fields.IntegerField')(unique=True)),
        ))
