...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Code.has_screen_shot'
        db.add_column('codewiki_code', 'has_screen_shot', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Code.has_screen_shot'
        db.delete_column('codewiki_code', 'has_screen_shot')
