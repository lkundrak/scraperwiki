...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invite.email'
        db.add_column('codewiki_invite', 'email', self.gf('django.db.models.fields.CharField')(default='fail@example.com', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invite.email'
        db.delete_column('codewiki_invite', 'email')
