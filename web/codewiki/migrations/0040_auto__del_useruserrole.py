...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'UserUserRole'
        db.delete_table('codewiki_useruserrole')


    def backwards(self, orm):
        
        # Adding model 'UserUserRole'
        db.create_table('codewiki_useruserrole', (
            ('other', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rev_useruserrole_set', to=orm['auth.User'])),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='useruserrole_set', to=orm['auth.User'])),
        ))
        db.send_create_signal('codewiki', ['UserUserRole'])
