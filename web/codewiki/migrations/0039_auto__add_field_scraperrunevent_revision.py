...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScraperRunEvent.revision'
        db.add_column('codewiki_scraperrunevent', 'revision', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScraperRunEvent.revision'
        db.delete_column('codewiki_scraperrunevent', 'revision')
