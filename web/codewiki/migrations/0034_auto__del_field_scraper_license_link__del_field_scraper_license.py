...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Scraper.license_link'
        db.delete_column('codewiki_scraper', 'license_link')

        # Deleting field 'Scraper.license'
        db.delete_column('codewiki_scraper', 'license')


    def backwards(self, orm):
        
        # Adding field 'Scraper.license_link'
        db.add_column('codewiki_scraper', 'license_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Scraper.license'
        db.add_column('codewiki_scraper', 'license', self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=100, blank=True), keep_default=False)
