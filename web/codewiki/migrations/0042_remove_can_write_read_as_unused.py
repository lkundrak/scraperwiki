...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CodePermission.can_read'
        db.delete_column('codewiki_codepermission', 'can_read')

        # Deleting field 'CodePermission.can_write'
        db.delete_column('codewiki_codepermission', 'can_write')


    def backwards(self, orm):
        
        # Adding field 'CodePermission.can_read'
        db.add_column('codewiki_codepermission', 'can_read', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CodePermission.can_write'
        db.add_column('codewiki_codepermission', 'can_write', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'codewiki.code': {
            ...
            'has_screen_shot': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'previous_privacy': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
        ...
        'codewiki.scraperrunevent': {
            ...
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
        ...
        'codewiki.vault': {
            'Meta': {'ordering': "['-name']", 'object_name': 'Vault'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'codewiki.vaultrecord': {
            'Meta': {'object_name': 'VaultRecord'},
            'count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'month': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'vault': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'records'", 'to': "orm['codewiki.Vault']"}),
