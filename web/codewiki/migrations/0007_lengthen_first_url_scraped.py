...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScraperRunEvent.first_url_scraped'
        # (to signature: django.db.models.fields.CharField(max_length=256, null=True, blank=True))
        db.alter_column('codewiki_scraperrunevent', 'first_url_scraped', orm['codewiki.scraperrunevent:first_url_scraped'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ScraperRunEvent.first_url_scraped'
        # (to signature: django.db.models.fields.CharField(max_length=128, null=True, blank=True))
        db.alter_column('codewiki_scraperrunevent', 'first_url_scraped', orm['codewiki.scraperrunevent:first_url_scraped'])
