...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Code.privacy_status'
        db.add_column('codewiki_code', 'privacy_status', orm['codewiki.code:privacy_status'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Code.privacy_status'
        db.delete_column('codewiki_code', 'privacy_status')
