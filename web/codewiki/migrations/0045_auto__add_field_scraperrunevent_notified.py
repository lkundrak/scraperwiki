...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScraperRunEvent.notified'
        db.add_column('codewiki_scraperrunevent', 'notified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScraperRunEvent.notified'
        db.delete_column('codewiki_scraperrunevent', 'notified')
    ...
    models = {
        ...
        'codewiki.invite': {
            ...
            'vault': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['codewiki.Vault']"})
        },
        'codewiki.scraper': {
