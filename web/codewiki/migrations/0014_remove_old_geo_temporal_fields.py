...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('codewiki_scraper', 'has_geo')

        # Deleting field 'Scraper.has_temporal'
        db.delete_column('codewiki_scraper', 'has_temporal')


    def backwards(self, orm):
        
        # Adding field 'Scraper.has_geo'
        db.add_column('codewiki_scraper', 'has_geo', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Scraper.has_temporal'
        db.add_column('codewiki_scraper', 'has_temporal', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
