...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Code.previous_privacy'
        db.add_column('codewiki_code', 'previous_privacy', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Code.previous_privacy'
        db.delete_column('codewiki_code', 'previous_privacy')
