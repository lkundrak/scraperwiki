...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VaultRecord'
        db.create_table('codewiki_vaultrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vault', self.gf('django.db.models.fields.related.ForeignKey')(related_name='records', to=orm['codewiki.Vault'])),
        ...
        db.send_create_signal('codewiki', ['VaultRecord'])


    def backwards(self, orm):
        
        # Deleting model 'VaultRecord'
        db.delete_table('codewiki_vaultrecord')
