...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Code.source'
        db.delete_column('codewiki_code', 'source')


    def backwards(self, orm):
        
        # Adding field 'Code.source'
        db.add_column('codewiki_code', 'source', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
