...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Code.vault'
        db.add_column('codewiki_code', 'vault', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='code_objects', null=True, to=orm['codewiki.Vault']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Code.vault'
        db.delete_column('codewiki_code', 'vault_id')
