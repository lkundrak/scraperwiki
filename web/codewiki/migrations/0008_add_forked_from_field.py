...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Code.forked_from'
        db.add_column('codewiki_code', 'forked_from', orm['codewiki.code:forked_from'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Code.forked_from'
        db.delete_column('codewiki_code', 'forked_from_id')
