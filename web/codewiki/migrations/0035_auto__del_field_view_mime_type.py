...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'View.mime_type'
        db.delete_column('codewiki_view', 'mime_type')


    def backwards(self, orm):
        
        # Adding field 'View.mime_type'
        db.add_column('codewiki_view', 'mime_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
