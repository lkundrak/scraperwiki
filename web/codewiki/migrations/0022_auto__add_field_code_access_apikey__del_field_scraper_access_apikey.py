...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Code.access_apikey'
        db.add_column('codewiki_code', 'access_apikey', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Deleting field 'Scraper.access_apikey'
        db.delete_column('codewiki_scraper', 'access_apikey')


    def backwards(self, orm):
        
        # Deleting field 'Code.access_apikey'
        db.delete_column('codewiki_code', 'access_apikey')

        # Adding field 'Scraper.access_apikey'
        db.add_column('codewiki_scraper', 'access_apikey', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'codewiki.vault': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'vaults'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
