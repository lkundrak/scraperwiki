...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Invite'
        db.create_table('codewiki_invite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('vault', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codewiki.Vault'])),
        ))
        db.send_create_signal('codewiki', ['Invite'])


    def backwards(self, orm):
        
        # Deleting model 'Invite'
        db.delete_table('codewiki_invite')
