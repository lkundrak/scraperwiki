...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Code.published'
        db.delete_column('codewiki_code', 'published')


    def backwards(self, orm):
        
        # Adding field 'Code.published'
        db.add_column('codewiki_code', 'published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
