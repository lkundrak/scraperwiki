...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vault.name'
        db.add_column('codewiki_vault', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vault.name'
        db.delete_column('codewiki_vault', 'name')
