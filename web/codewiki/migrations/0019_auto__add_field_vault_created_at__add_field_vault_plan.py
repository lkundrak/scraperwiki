...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vault.created_at'
        db.add_column('codewiki_vault', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 9, 12, 15, 13, 25, 966637), blank=True), keep_default=False)

        # Adding field 'Vault.plan'
        db.add_column('codewiki_vault', 'plan', self.gf('django.db.models.fields.CharField')(default='corporate', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vault.created_at'
        db.delete_column('codewiki_vault', 'created_at')

        # Deleting field 'Vault.plan'
        db.delete_column('codewiki_vault', 'plan')
