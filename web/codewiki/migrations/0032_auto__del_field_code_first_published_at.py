...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Code.first_published_at'
        db.delete_column('codewiki_code', 'first_published_at')


    def backwards(self, orm):
        
        # Adding field 'Code.first_published_at'
        db.add_column('codewiki_code', 'first_published_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
