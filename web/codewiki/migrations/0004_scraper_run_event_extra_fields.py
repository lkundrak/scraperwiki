...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'View.render_time'
        db.add_column('codewiki_view', 'render_time', orm['codewiki.view:render_time'])
        
        # Adding field 'ScraperRunEvent.first_url_scraped'
        db.add_column('codewiki_scraperrunevent', 'first_url_scraped', orm['codewiki.scraperrunevent:first_url_scraped'])
        
        # Adding field 'ScraperRunEvent.exception_message'
        db.add_column('codewiki_scraperrunevent', 'exception_message', orm['codewiki.scraperrunevent:exception_message'])
        
        # Changing field 'View.mime_type'
        # (to signature: django.db.models.fields.CharField(max_length=255, null=True, blank=True))
        db.alter_column('codewiki_view', 'mime_type', orm['codewiki.view:mime_type'])
        
        # Changing field 'ScraperRunEvent.run_id'
        # (to signature: django.db.models.fields.CharField(db_index=True, max_length=100, null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'View.render_time'
        db.delete_column('codewiki_view', 'render_time')
        
        # Deleting field 'ScraperRunEvent.first_url_scraped'
        db.delete_column('codewiki_scraperrunevent', 'first_url_scraped')
        
        # Deleting field 'ScraperRunEvent.exception_message'
        db.delete_column('codewiki_scraperrunevent', 'exception_message')
